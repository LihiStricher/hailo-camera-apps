...
// Enlarge Face Bbox Params
#define ENLARGE_FACE_BBOX_STAGE "enlarge_face_bbox"
#define ENLARGE_FACE_BBOX_ID 2
#define ENLARGE_FACE_BBOX_SCALE 1.2f
// Landmarks AI Params
